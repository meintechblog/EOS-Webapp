...
class SetupFieldService:
    ...
    def _field_defs(self, payload: dict[str, Any]) -> list[SetupFieldDef]:
        ...
        return [
            ...
            SetupFieldDef("param.prediction.historic_hours", "optional", "Prediction Historie", False, "number", "h", None, 1, 2160, ("prediction", "historic_hours"), None, "/eos/set/param/prediction/historic_hours=<value>"),
            *(
                [
                    SetupFieldDef(
